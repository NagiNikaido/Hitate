...
int main() {
	...
	scene.setCamera(new HApertureCamera(HVec3(10, 2, 2), 0.2, 6, HVec3(-1, 0, 0), HVec3(0, 0, 1), 70, .75));
	/*
	...
	*/
	...
	/*
	scene.setCamera(new HPinholeCamera(HVec3(1, -0.5, 1), HVec3(-1, 0.4, -0.8), HVec3(0, 0, 1), 70, .75));
	...
	*/
	...
	cv::resize(canvas, canvas, cv::Size(canvas.size[1] , canvas.size[0] ));
